    ...
    function browser(){
      ...
      // test for Mozilla Alpha/Beta Versions
        ...
        // test for Safari
            ...
            $bd['browser'] = "Safario";
            $bd['version'] = "";
						$val = explode(" ",stristr($agent,"AppleWebKit"));
            $val = explode("/",$val[0]);
            $bd['browser'] = $val[0];
            $bd['version'] = $val[1];
...
$br = new Browser;
$br_version = explode('.',$br->Version);
$br_name = strtolower($br->Name);
$br_so = strtolower($br->Platform);
$claseNav = 'nav '.$br_so.' '.$br_name.' '.$br_name.'_'.$br_version[0].$br_version[1];
//echo "$br->Platform, $br->Name version $br->Version";
?>